...
import {
    ...
    TableHeader,
    TableRow,
} from "@better-analytics/ui/components/table";
                ...
                <div className="flex flex-col items-start justify-between gap-3 sm:flex-row">
                    ...
                    {showSearch && (
                        <div className="relative w-full flex-shrink-0 sm:w-auto">
                            <MagnifyingGlass className="-translate-y-1/2 absolute top-1/2 left-2 h-3 w-3 transform text-muted-foreground/50" />
                            <Input
                    ...
                    <div className="mt-3 overflow-hidden">
                        <div className="-mb-1 overflow-x-auto pb-1">
                            <nav
                                ...
                                className="inline-flex gap-1 rounded bg-muted/40 p-1"
                            >
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "flex items-center gap-1 rounded-md px-3 py-2 font-medium text-sm transition-all duration-200",
                                                        ...
                                                        {header.column.getCanSort() && (
                                                            <div className="flex h-3 w-3 flex-col items-center justify-center">
                                                                {!header.column.getIsSorted() && (
                                                                    <ArrowsClockwise className="h-3 w-3 text-muted-foreground/40 transition-colors group-hover:text-muted-foreground/70" />
                                                                )}
                                                                {header.column.getIsSorted() === "asc" && (
                        ...
                        >
                            <div className="mb-4">
                                <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-muted/20">
                                    {globalFilter ? (
                                        <MagnifyingGlass className="h-7 w-7 text-muted-foreground/50" />
                                    ) : (
