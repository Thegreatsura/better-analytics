...
export type ErrorVsLogsChartProps = {
    data: ErrorVsLogTrendItem[];
    loading?: boolean;
}
...
export function ErrorVsLogsChartSkeleton() {
    return (
...
export function ErrorVsLogsChart(props: ErrorVsLogsChartProps) {
    if (props.loading) {
        return <ErrorVsLogsChartSkeleton />;
    }
    ...
    return (
        <ResponsiveContainer>
            ...
            >
                <defs>
                    <pattern id="patternErrors" patternUnits="userSpaceOnUse" width={8} height={8}>
                        <rect width={8} height={8} fill="#EF4444" fillOpacity={0.3} />
                        <path d="M0 8 L8 0" stroke="#EF4444" strokeWidth={1} />
                    </pattern>
                    <pattern id="patternLogs" patternUnits="userSpaceOnUse" width={8} height={8}>
